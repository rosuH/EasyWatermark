...
- [ ] `AGENTS.md`, `docs/CONTEXT.md`, ADRs, local `.scratch` status/plan tickets, and verified evidence reflect final architecture (process contract = this file; ACSP is the active handoff protocol).
