...
| Shared session | **ADR-0017 Accepted** — KMP `WatermarkSessionViewModel` + ports + CMP-first; Phase 0 scaffold landed. Gates: Android SKILL + performance (ADR §4–§5). Next: Phase 1 nav/selection |
