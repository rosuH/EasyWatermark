...
| Shared session | **ADR-0017** Phase **0+1 landed** — `AppIntent`/`SessionReducer`/`WatermarkSessionViewModel`; Android extends session VM. Gates: skill+perf. Next: **Phase 2** export ports |
