...
final class PickerFlowUITests: XCTestCase {
    ...
    func testAboutFromLaunchBacksToLaunch() {
        ...
        // Version row trailing should show product version 3.0.2 (not "iOS").
        let versionLabel = app.staticTexts.matching(NSPredicate(format: "label == %@", "3.0.2")).firstMatch
        XCTAssertTrue(versionLabel.waitForExistence(timeout: 15),
                      "About version 3.0.2 not visible (got wrong/missing version).")
