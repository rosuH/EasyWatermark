 ...
 * shared [FuncType.label] / [FuncType.iconPainter] from composeResources (ADR-0019).
 * Identity is [type]; optional [valueRange] for sliders that still construct a model.
 */
@Keep
