 ...
 * Exists. `Density(1f)` ⇒ image-space (`1.sp == 1px`), the C2b "image-space sizing" direction, * decoupled from any view/window density.
 */
 ...
 * Family + style flags + px size) into a Compose [TextStyle], with `includeFontPadding = true` to match * `StaticLayout`'s default. Mirrors session 215406's mapping exactly (behavior-preserving for the gate).
 */
