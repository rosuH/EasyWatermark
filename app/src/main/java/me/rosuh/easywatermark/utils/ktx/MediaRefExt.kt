 ...
 * Neutral model is API-agnostic; the Android framework [Uri] appears only HERE at the Android edge, * exactly as `ImageFormat.toCompressFormat()` / `WatermarkTileMode.toShaderTileMode()` do.
 *
